...
public class GoatLatin {
    public static void main(String[] args) {
        ...
        System.out.println(latin.toGoatLatin("I speak Goat Latin"));
    }
    ...
    public String toGoatLatin(String sentence) {
        ...
        for (int i = 0; i < len; ) {
            ...
            if ("aeiouAEIOU".indexOf(sentence.charAt(i)) > -1) {
                ans.append(sentence.substring(i, j)).append("ma");
            } else {
                ans.append(sentence.substring(i + 1, j)).append(sentence.charAt(i)).append("ma");
            }
            ans.append(last);
            last += "a";
            i = j + 1;
