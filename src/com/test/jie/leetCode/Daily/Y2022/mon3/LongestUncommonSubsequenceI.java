...
public class LongestUncommonSubsequenceI {
    public static void main(String[] args) {
        LongestUncommonSubsequenceI subsequenceI = new LongestUncommonSubsequenceI();
        System.out.println(subsequenceI.findLUSlength("aaa", "aaa"));
        System.out.println(subsequenceI.findLUSlength("aba", "cdc"));
        System.out.println(subsequenceI.findLUSlength("aaa", "bbb"));
    }
