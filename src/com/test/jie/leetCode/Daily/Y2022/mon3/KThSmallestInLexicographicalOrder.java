...
public class KThSmallestInLexicographicalOrder {
    ...
    public static void main(String[] args) {
        KThSmallestInLexicographicalOrder order = new KThSmallestInLexicographicalOrder();
        System.out.println(order.findKthNumber(13, 2));
        System.out.println(order.findKthNumber(1, 1));
    }
}
